...
<body>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('assets/front/assets/img/post-bg.jpg')">
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <hr >
                    <img src="<?php echo $post['image']; ?>" alt="" style="width:300px" class="m-2 rounded" class="m-2 rounded">
                    </p>
                </div>
            </div>
        </div>
